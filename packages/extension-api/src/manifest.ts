...
export const CURRENT_EXTENSION_API_VERSION = '1.3.0' as const
export const SUPPORTED_EXTENSION_API_VERSIONS = [CURRENT_EXTENSION_API_VERSION, '1.2.0', '1.1.0', '1.0.0'] as const
