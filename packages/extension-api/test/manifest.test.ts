...
describe('API v1.3 minor compatibility fixtures', () => {
  it('keeps v1.2, v1.1 and v1.0 manifests compatible while negotiating the current v1.3 Host', async () => {
    expect(CURRENT_EXTENSION_API_VERSION).toBe('1.3.0')
    expect(SUPPORTED_EXTENSION_API_VERSIONS).toEqual(['1.3.0', '1.2.0', '1.1.0', '1.0.0'])
