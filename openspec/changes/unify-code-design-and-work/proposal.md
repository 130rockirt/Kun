...
- Turn Design into a conversation mode inside the Code workbench. Users choose Code or Design before the first message; the first accepted turn locks that mode for the conversation.
...
- `unified-code-design-tasks`: One Code workbench surface with a pre-send Code/Design choice, shared navigation, stable thread ownership, and immutable conversation mode after the first accepted turn.
