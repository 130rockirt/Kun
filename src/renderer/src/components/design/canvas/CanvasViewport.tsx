...
export function CanvasViewport({
  ...
  const onPointerDown = useCallback(
    (e: React.PointerEvent) => {
      ...
      e.preventDefault()
      if (canvasSurfaceScopesKeyboard(surface)) rootRef.current?.focus({ preventScroll: true })
  ...
  return (
    <CanvasWorkspaceContext.Provider value={workspaceValue}>
      <div
        ref={rootRef}
        tabIndex={canvasSurfaceScopesKeyboard(surface) ? -1 : undefined}
        ...
        >
          ...
          >
            {!readOnly ? <CanvasToolbar
              ...
              onExportCanvas={canvasSurfaceSupportsExport(surface) ? exportCanvas : undefined}
              onError={onError}
            /> : null}
          </div>
        </CanvasViewportChrome>
