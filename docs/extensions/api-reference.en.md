...
| --- | --- | --- | --- | --- |
| `@kun/extension-api` | `1.2.0` | `.`<br>`./manifest.schema.json` | 497 | `cc5a1819fbdfa928bfdb0a5913779cf080165841992d008ef7b2680199467e42` |
...
| `@kun/extension-test` | `fake-basic-services` | `createGeneratedArtifactFixture`<br>`FakeAgentService`<br>`FakeStorageService`<br>`FakeWorkspaceService` | — |
