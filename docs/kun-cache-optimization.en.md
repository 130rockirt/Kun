...
the local agent's request prefix long-term stable, verifiable, and observable across Code (including Design tasks), Work, and Connect phone.
...
In this way, Code (including Design tasks), Work, and Connect phone can share the same caching disciplines.
